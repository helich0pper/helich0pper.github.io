...
Rating: <span style="color:yellow">Medium</span> <br>
My Rating: <span style="color:yellow">Medium</span> <br>
...
{% endhighlight %}
## ArkScv
Luckily, the ArkScv can also be remotely logged in with evil-winrm. Upon checking what groups ArkScv is in we can see he is a part of AD Recycle Bin.
{% highlight bash %}
