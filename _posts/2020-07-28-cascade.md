...
What if we added a breakpoint here and ran CascAudit.exe with the Audit database file as an argument? Theoretically, we should be able to read the password at the breakpoint in plain text. <br>
