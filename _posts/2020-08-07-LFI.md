---
title: "TryHackMe | Remote Code Execution With LFI"
layout: post
---
...
```
I have pasted the raw base64 below as well in case you want to - paste it.
```
...
PentestMonkey has a good <a target="_blank" href="http://pentestmonkey.net/tools/web-shells/php-reverse-shell">PHP reverse shell</a> that we can use. Note this is not the most subtle option but it works well._ <br>
